# This is a repositorty dedicated to daily HackerRank or NeetCode challenges
...
Currently solving NeetCode's roadmap - https://neetcode.io/roadmap

## Table of contents
### HackerRank easy
- [Find the Smallest Missing Positive Integer](#challenge-1---find-the-smallest-missing-positive-integer)
- [Check for Non-Identical String Rotation](#challenge-2---check-for-non-identical-string-rotation)
- [Target Index Search](#challenge-3---target-index-search)
- [Find First Occurrence](#challenge-4---find-first-occurrence)
- [Maximum Number of Non-Overlapping Intervals](#challenge-5---maximum-number-of-non-overlapping-intervals)
- [Validate Properly Nested Brackets](#challenge-6---validate-properly-nested-brackets)
- [Min-Tracking Stack Implementation](#challenge-7---min-tracking-stack-implementation)
- [One-Pass Removal of k-th Node from End](#challenge-8---one-pass-removal-of-k-th-node-from-end)
- [Count Number Pairs](#challenge-9---count-number-pairs)
- [Remove Consecutive Duplicates from Sorted Linked List](#challenge-10---remove-consecutive-duplicates-from-sorted-linked-list)
- [Generate Valid Angle Bracket Sequences](#challenge-11---generate-valid-angle-bracket-sequences)
- [Remove Elements Within K Distance](#challenge-12---remove-elements-within-k-distance)
- [Two Sum (Time Slot Task Pairing)](#challenge-13---two-sum-time-slot-task-pairing)
- [Check Valid Anagram](#challenge-14---check-valid-anagram)
- [Lexicographical Letter Combinations of Phone Digits](#challenge-15---lexicographical-letter-combinations-of-phone-digits)
- [Place N Cameras Without Conflict on Blocked Grid](#challenge-16---place-n-cameras-without-conflict-on-blocked-grid)
- [Custom Fibonacci Sequence](#challenge-17---custom-fibonacci-sequence)
- [Ways to Fill Slots with Single or Double Coverage](#challenge-18---ways-to-fill-slots-with-single-or-double-coverage)

### NeetCode - Arrays & Hashing
- [Concatenation of Array](#challenge-1---concatenation-of-array)
- [Contains Duplicate](#challenge-2---contains-duplicate)
- [Valid Anagram](#challenge-3---valid-anagram)
...
## Challenge 1 - Concatenation of Array
...
## Challenge 5 - Longest Common Prefix
